...
- 当前版本：`7.1`（`versionCode=710`）；语音助手：`3.4`（`versionCode=34`，本轮未重新打包）
...
### 2.0.5 上一轮开发记录（6.5 / 3.4，2026-07-26）
...
### 2.0.6 上一轮开发记录（6.3 / 3.3，2026-07-15）
...
- 最新版本：`7.1`（专注页整页连续滚动、物种完整名称查看、图片识别 API 纵向选择，以及依赖维护边界）
