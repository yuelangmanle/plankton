...
- 当前版本：`6.9`（`versionCode=690`）；语音助手：`3.4`（`versionCode=34`，本轮未重新打包）
...
### 2.0.4 上一轮开发记录（6.5 / 3.4，2026-07-26）
...
### 2.0.5 上一轮开发记录（6.3 / 3.3，2026-07-15）
...
- 最新版本：`6.9`（高级设置状态持久化、模型长按/能力建议、跨设备数据包、GitHub 更新、正式签名、API 中心与跨设备稳定渲染）
