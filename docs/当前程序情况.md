...
- 当前版本：`7.0`（`versionCode=700`）；语音助手：`3.4`（`versionCode=34`，本轮未重新打包）
...
- 最新版本：`7.0`（工作会话栏、普通页快速计数、手动步进、跨图片冲突确认、图片任务状态/取消、采样解码与高刷实际状态）
